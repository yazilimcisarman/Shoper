...
{
    /// <inheritdoc />
    public partial class newmigrationorderorderıtems : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingCityId = table.Column<int>(type: "int", nullable: false),
                    ShippingTownId = table.Column<int>(type: "int", nullable: false),
